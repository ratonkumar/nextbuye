...
Route::get('product-single/{slug}', [WebviewController::class, 'productDetailsSingle']);
...
Route::get('/top-sale', [WebviewController::class, 'topSale'])->name('topSale');
...
Route::get('single-add-to-cart', [CartController::class, 'singleAddCart']);
...
Route::post('press/orderOnline', [OrderController::class, 'onlineOrder']);
