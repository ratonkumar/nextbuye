...
Route::get('/notes_add', [NoteController::class, 'index'])->name('notes.index');
Route::post('/notesadd', [NoteController::class, 'store'])->name('notes.store');
...
Route::group(['prefix'=>'admin','middleware' => ['auth.admin:admin']], function () {
    ...
    Route::get('/users/status/update/{id}', [UserController::class, 'statusUpdate']);
    ...
    Route::put('slider/status', [SliderController::class, 'statusupdate']);
     Route::get('ip/list', [IpController::class, 'index'])->name('admin.ipList.data');
    Route::get('ip/block/added/{id}', [IpController::class, 'blocked'])->name('admin.blocked.data'); 
    ...
    Route::get('products-gallery-image-remove/{id}', [ProductController::class, 'productgalleryImageRemove'])->name('admin.product.productgalleryImageRemove');
    Route::get('product/gallery-image/remove', [ProductController::class, 'removeGalleryImage'])->name('product.gallery.image.remove');
    
    Route::get('products-edit-weight/{id}', [ProductController::class, 'productWightEdit'])->name('admin.product.edit_weight');
    Route::get('products-edit-category/{id}', [ProductController::class, 'productCategoryEdit'])->name('admin.product.edit_category');
    Route::get('products-edit-page/{id}', [ProductController::class, 'productPageEdit'])->name('admin.product.productPageEdit');
