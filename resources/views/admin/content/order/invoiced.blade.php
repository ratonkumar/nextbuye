...
<main id="main" class="main">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
         ...
         <div class="col-md-6 col-xl-2">
            <a href="{{ url('admin_order/InTransit') }}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="text-dark mt-1 mb-0">
                                    <span id="in_transit" data-plugin="counterup">0</span>
                                </h3>
                                <p class="text-muted mb-1 text-truncate">In transit</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item btn-change-status" data-status="Stock Out"
                                                href="#">Stock Out</a>
                                            <a class="dropdown-item btn-change-status" data-status="In Transit"
                                                href="#">In Transit</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data["status"] == "success") {
                        ...
                        $('#in_transit').text(data["in_transit"]);
                        // console.log(data)
                    } else {
                        if (data["status"] == "failed") {
                            swal(data["message"]);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    function calculation() {
                        ...
                        var paymentAmount = +$("#paidAmount").val();
