...
<main id="main" class="main">
    ...
    <div class="row">
        ...
        <div class="col-md-7 col-xl-2">
            @if ($admin->hasrole('user'))
                <a href="{{ url('admin_order/myorder') }}">
                    <div class="widget-rounded-circle card-box order pt-1 pb-1">
                        <div class="row">
                            <div class="col-12">
                                <div class="float-left">
...
<script>
    $(document).ready(function() {
                ...
                success: function(response) {
                    ...
                    $("#productID").select2({
                        ...
                        $("#productTable tbody").append(
                            ...
                            e.params.data.id + '" id="ProductWeight" value=""  class=" form-control" style="width:80px;" value="1"></td</td>' +
                            '<td><span class="productName">' + e.params.data
                            .text + '</span></td>' +
                            '<td><input type="text" class="productQuantity form-control" data-id="' +
                            e.params.data.id + '" style="width:80px;" value="1"></td>' +
                            '<td><span class="productPrice">' + e.params.data
                            .productPrice + '</span> <input type="hidden" value="' + e.params.data
                            .productPrice + '" id="product_price_' + e.params.data
                            .id + '"></td>' +
                            '<td><span id="totalPrice' + e.params.data
                            .id + '">' + e.params.data
                    ...
                    $(document).on("input", ".productQuantity", function() {
                        ...
                        var productPrice = parseFloat($('#product_price_' + value).val()) || 0;
                        
                        // Specific Row Total Update
                        var rowTotal = productPrice * qty;
                        $('#totalPrice' + value).html(rowTotal.toFixed(2));
                        
                        // Full Form-er Total Update korar function call
                        calculation(); 
                    });
                    ...
                    function calculation() {
                        ...
                        $("#total").text(subtotal + deliveryCharge -
                            discountCharge - paidAmount);
                            
                        $("#totalAmount").val(subtotal + deliveryCharge );
                        $("#totalPayble").val(subtotal + deliveryCharge -discountCharge );
                    }
        ...
        $(document).on("click", "#btn-update", function() {
            ...
            var memo = $("#memo").val();
            var totalPayble = +$("#totalPayble").val();
             var paidAmount = $("#paidAmount").val();
            var product = [];
            var productCount = 0;
