                ...
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($order->products as $product)
                                <tr>
                                    ...
                                    <td><span class="productCode"><input type="text" name="weight" id="ProductWeight"
                                                value="{{ $product->weight }}" style="    max-width: 80px;"> </span></td>
                                    <td><span class="productName">{{ $product->productName }}</span></td>
                                    <td><input type="text" data-id="{{  $product->id }}" class="productQuantity form-control"
                                            style="width:80px;" value="{{ $product->quantity }}"></td>
                                    <td><span class="productPrice">{{ $product->productPrice }}</span> <input type="hidden" value="{{ $product->productPrice }}" id="product_price_{{  $product->id }}"></td>
                                    <td><span id="totalPrice{{  $product->id }}">{{ $product->productPrice*  $product->quantity}}</span></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row mb-2">
                                <label for="fname"
                                       class="col-sm-4 text-right control-label col-form-label">Total Amount</label>
                                <div class="col-sm-8">
                                    <input type="text" value="{{ $order->subTotal +  $order->deliveryCharge }}" class="form-control"
                                           id="totalAmount">
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-2">
                                <label for="fname"
                                    class="col-sm-4 text-right control-label col-form-label">Total Payble</label>
                                <div class="col-sm-8">
                                    <input type="text" value="{{ $order->subTotal +  $order->deliveryCharge - $order->discountCharge }}" class="form-control"
                                        id="totalPayble">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-2">
                                <label for="fname"
                                       class="col-sm-4 text-right control-label col-form-label">Paid Amount</label>
                                <div class="col-sm-8">
