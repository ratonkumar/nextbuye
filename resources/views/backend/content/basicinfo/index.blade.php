                        ...
                        <div class="col-lg-6">
                              ...
                              <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="title"
                                    value="{{ $webinfo->title }}" id="title" placeholder="title">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="inv_slug"
                                    value="{{ $webinfo->inv_slug }}" id="inv_slug" placeholder="Invoice">
                                <label for="floatingPassword">Invoice Slug</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="header_bg_color" value="{{ $webinfo->header_bg_color }}"
                                    id="header_bg_color" >
                                <label for="floatingInput">Header Bg color</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="button_color" value="{{ $webinfo->button_color }}"
                                    id="button_color" >
                                <label for="floatingInput">Theme color / Button Bg color</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="footer_bg_color" value="{{ $webinfo->footer_bg_color }}"
                                    id="footer_bg_color" >
                                <label for="floatingInput">Footer Bg color</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="order_now_bg_color" value="{{ $webinfo->order_now_bg_color }}"
                                    id="order_now_bg_color" >
                                <label for="floatingInput">Order Now Color</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="header_menu_hover_color" value="{{ $webinfo->header_menu_hover_color }}"
                                    id="header_menu_hover_color" >
                                <label for="floatingInput">Hover Color</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="categories_bg_color" value="{{ $webinfo->categories_bg_color }}"
                                    id="categories_bg_color" >
                                <label for="floatingInput">Categories Bg Color</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="single_order_button" value="{{ $webinfo->single_order_button }}"
                                    id="single_order_button" >
                                <label for="floatingInput">Single page order button bg</label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                            ...
                            <div class="mb-3">
                                <input class="form-control form-control-lg bg-dark" name="fevicon" id="fevicon"
                                    type="file">
                            </div>
                             <div class="m-3 ms-0" style="text-align: center;height: 85px;margin-top:50px !important">
                                <h4 style="width:30%;float: left;text-align: left;">Fevicon : </h4>
                                <img src="{{ asset($webinfo->fevicon) }}" alt="" srcset=""
                                    style="max-height: 100px;">
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="whatsapp"
                                    value="{{ $webinfo->whatsapp }}" id="whatsapp" placeholder="whatsapp">
                                <label for="floatingPassword">Whatsapp Number</label>
                            </div>
                            <div class="form-floating mb-3">
                                <textarea type="text" class="form-control" name="copyright" id="copyright" placeholder="copyright"> {{  $webinfo->copyright }}  </textarea>
                                <label for="floatingPassword">Copy right</label>
                            </div>
                             <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="weight_name"
                                    value="{{ $webinfo->weight_name }}" id="weight_name" placeholder="weight_name ">
                                <label for="floatingPassword"> ওজন/ পরিমাণ  ?</label>
                            </div>
                            
                             <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="order_note"
                                    value="{{ $webinfo->order_note }}" id="order_note" placeholder="order_note ">
                                <label for="floatingPassword"> Order print note ?</label>
                            </div>
                            <div class="mt-3">
