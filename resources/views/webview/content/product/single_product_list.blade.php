                                    ...
                                    <div class="product-micro">
                                        <div class="row product-micro-row">
                                            <div class="col-12">
                                                <div class="product-image">
                                                    <div class="image text-center">
                                                        <a href="{{ url('product-single/' . $categoryproduct->ProductSlug) }}">
                                            ...
                                            <div class="col-12">
                                                <div class="infofe p-md-3 p-2" style="padding-bottom: 4px !important;">
                                                    <div class="product-info p-0">
                                                        <h2 class="name text-truncate" id="f_name"><a
                                                                href="{{ url('product-single/' . $categoryproduct->ProductSlug) }}"
                                                ...
                                                <a class="btn btn-danger btn-sm mb-0 btn-block"
                                                    href="{{ url('product-single/' . $categoryproduct->ProductSlug) }}" style="width: 100%;border-radius: 0%;color: white;"
                                                    id="purcheseBtn">অর্ডার করুন</a>
