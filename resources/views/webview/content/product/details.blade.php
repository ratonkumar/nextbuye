...
>
    <div style="display: flex; align-items: center; gap: 12px; min-width: 0px">
        <div
            style="
                ...
                height: 46px;
                border-radius: 12px;
                background: radial-gradient(circle, rgb(244, 236, 224), rgb(230, 216, 196));
                flex-shrink: 0;
                overflow: hidden;
                position: relative;
            "
        >
            <img
                ...
                data-nimg="fill"
                class="object-cover"
                src="/landing/choplet/product.webp"
                style="position: absolute; height: 100%; width: 100%; inset: 0px; color: transparent"
            />
        </div>
        <div style="min-width: 0px">
            <div class="bh" style="font-weight: 700; font-size: 15px; white-space: nowrap">
                Choplet — <span class="num" style="font-weight: 800">৳990</span>
                <span class="bn" style="font-size: 12px; color: rgb(138, 130, 120); font-weight: 500"
                    >· ফ্রি ডেলিভারি</span
                >
            </div>
            <div
    ...
    <button
        ...
        "
    >
        অর্ডার করুন<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4">
            <path d="M5 12h14M13 6l6 6-6 6"></path>
        </svg>
    </button>
</div>
